  ...
  tick() {
    ...
    if (this.segments === undefined || this.segments.length < 2) {
      ...
      player.teleport(
        {
          x:
            this.segments[activeSegmentIndex].x +
            (this.segments[activeSegmentIndex + 1].x - this.segments[activeSegmentIndex].x) * ticksInSegmentPercent,
          y:
            this.segments[activeSegmentIndex].y +
            (this.segments[activeSegmentIndex + 1].y - this.segments[activeSegmentIndex].y) * ticksInSegmentPercent,
          z:
            this.segments[activeSegmentIndex].z +
            (this.segments[activeSegmentIndex + 1].z - this.segments[activeSegmentIndex].z) * ticksInSegmentPercent,
        },
        {
          rotation: {
            x: 0,
